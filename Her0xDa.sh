...
Temporary="/tmp/Her0xDa-WPS-Cracker"

####################################################
########Verify the folder of Temporary files########
####################################################
   Ver_Dir=`ls /tmp | grep -E '^Her0xDa-WPS-Cracker$'`
   if [ "$Ver_Dir" != "" ];then
	    rm -rf ${Temporary}
	    mkdir ${Temporary}
   else
...
echo -e "$White [+]$Green Greetz to : ${Cyan}X-Hydr0${White} ."
echo ""
exit
}
kill_wep_function() {
...
sleep 0.1
echo -e "                          |${BRed} Her0xDa${BYellow} Tool${BPurple} WPS${BGreen} Cracker${Yellow} |"
sleep 0.1
...
case $menu in
			...
			"4")
			  ...
			  "5")
                 ...
                 if [ "$VerMon" != "" ]
                      then
						   ...
						   Ver_Dir=`ls /tmp/Her0xDa-WPS-Cracker | grep -E '^capture$'`
						   if [ "$Ver_Dir" != "" ];then
	      			            rm -rf ${Temporary}/capture
								mkdir ${Temporary}/capture
						   else
			  ...
			  "7")
                  echo ""
                  echo -e "$White[${Green} ok ${White}]$Green Her0xDa-WPS Cracker$White By$BYellow Her0xDa X."
                  echo ""
			      exit
			      ;;
			  *)
...
sleep 0.1
echo -e "             ##   ${Cyan}-Author   ${White}:      {${Yellow} Her0xDa ${White}}                ${Green}##"
sleep 0.1
echo -e "             ##   ${Cyan}-Country  ${White}:      {${Red} Hell ${White}}                     ${Green}##"
sleep 0.1
echo -e "             ##   ${Cyan}-Email    ${White}:      {${Purple} ceyborgxda@gmail.com ${White}}   ${Green}##"
sleep 0.1
echo -e "             ########################################################"
sleep 0.1
echo ""
